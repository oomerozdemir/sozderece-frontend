...
export const PACKAGES = {
  ...
  "ozel-ders-plus-hazir-2026": {
    ...
    features: [
      { label: "Seçtiğin öğretmenden 2 özel ders", included: true },
      { label: "Sana özel 2 haftalık koçluk programı", included: true },
      { label: "2 haftada bir 40 dk koçunla görüşme ve durum analizi", included: true },
  ...
  "kocluk-ozel-ders-2026": {
    ...
    features: [
      { label: "Kişiye özel tam kapsamlı koçluk programı", included: true },
      { label: "Haftada bir koç ile görüşme", included: true },
      { label: "7/24 WhatsApp desteği", included: true },
      { label: "Günlük takip ve durum analizi ", included: true },
      { label: "Seçtiğin öğretmenden 4 özel ders/ay", included: true },
      { label: "Özel Ders Paket İçeriği", included: true },
