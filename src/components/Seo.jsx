...
const Seo = ({ 
  ...
  const defaultDesc = "Sözderece Koçluk ile YKS ve LGS sınavlarına hazırlanın. Kişiye özel ders programı, deneme analizi, motivasyon desteği ve derece öğrencisi koçlarla başarıya ulaşın. İlk 7 gün koşulsuz iade garantisi.";
