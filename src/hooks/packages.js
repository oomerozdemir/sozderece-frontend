...
export const PACKAGES = {
  ...
  "ozel-ders-paketi": {
    ...
    features: [
      { label: "Alanında Uzman Öğretmenlerden Özel Ders", included: true },
  ...
  "ozel-ders-plus-hazir-2026": {
    ...
    features: [
      { label: "Seçtiğin Öğretmenden 2 Özel Ders Hakkı", included: true },
  ...
  "kocluk-ozel-ders-2026": {
    ...
    features: [
      ...
      { label: "7/24 WhatsApp Desteği", included: true },
      { label: "Günlük Takip Ve Durum Analizi ", included: true },
      { label: "Seçtiğin Öğretmenden 4 Özel Ders Hakkı", included: true },
      { label: "Özel Ders Paket İçeriği", included: true },
