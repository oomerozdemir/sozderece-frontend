...
import Seo from "../components/Seo"; // Seo bileşenini dahil ettik
  ...
  return (
    <>
      <Seo 
        ...
        description="Sözderece Koçluk hizmetlerinde 5 gün koşulsuz iade hakkı, cayma süreci ve geri ödeme koşulları hakkında detaylı bilgilendirme."
      />
